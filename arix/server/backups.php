...
return [
    ...
    'create' => [
        'title' => '創建伺服器備份',
        'backup-name' => '備份名稱',
        'backup-name-description' => '如果提供，這名字會是您能快速找到這備份的依據',
        'ignored-files-directories' => '忽略的檔案 / 資料夾',
        'ignored-files-directories-description' => '輸入在創建這個備份的時候要跳過的檔案 / 資料夾，如果要用 "/home/container/.pteroignore" 的設定，請將此處留空。通用符號可用於指定檔案，您也可以在路徑前面加上 "!" 來取消此規則',
        'locked' => '已鎖定',
