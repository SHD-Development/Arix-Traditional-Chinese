...
return [
    ...
    'twofactor' => [
        ...
        'setup-dialog' => [
            'description' => '在兩步驟驗證應用程式內掃描此 QR Code，然後輸入應用程式生成的 6 碼驗證碼。',
    ...
    'apiKey' => [
        ...
        'allowedIPs-description' => '留空以讓任何 IP 都可以使用此 API 金鑰，每行輸入一個 IP 地址。',
        'createButton' => '創建',
    ...
    'recoveryTokensDialog' => [
        'title' => '兩步驟驗證已啟用',
        'description' => '請妥善保存這些備用碼，如果您的兩步驟驗證裝置遺失了，可以用這些備用碼來恢復您的帳號。',
        'alert' => '這些代碼不會再次顯示。',
        'doneButton' => '完成',
    ],
];
