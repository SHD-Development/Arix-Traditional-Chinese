...
return [
    ...
    'update-password' => [
        'current' => '目前密碼',
        'new' => '新的密碼',
        'requirements' => '你的密碼應該要至少 8 個字並且應與其他網站不同。',
        'confirm' => '確認密碼',
        'update' => '更改密碼',
    ],
    ...
    'twofactor' => [
        ...
        'disable-dialog' => [
            'password' => '密碼',
            'cancel' => '取消',
            'must-enter-password' => '你必須輸入密碼才能繼續。',
            'disable' => '禁用',
        ],
        ...
        'setup-dialog' => [
            ...
            'enter-6digit-password' => '你必須輸入密碼和 6 碼驗證碼來繼續',
            'enable' => '啟用',
            'cancel' => '取消',
        ],
    ],
    ...
    'apiKey' => [
        ...
        'your-keys' => '你的 API 金鑰',
        'store-save' => '你請求的 API 金鑰在下方，因將不會再次顯示所以請妥善保存。',
        'close' => '關閉',
        ...
        'loading' => '載入中...',
        'no-key-found' => '你的帳號沒有任何的 API 金鑰。',
        'last-used' => '最後使用',
    ],

    'sshKey' => [
        'loading' => '載入中...',
        'no-key-found' => '你的帳號沒有任何的 SSH 金鑰。',
        'added-on' => '已加上',

        'createForm' => [
            'key-name' => 'SSH 金鑰名稱',
            'public-key' => '公鑰',
            'public-key-desc' => '輸入你的 SSH 公鑰。',
            'save' => '儲存',
        ],
    ...
    'recoveryTokensDialog' => [
        'title' => '兩步驟驗證已啟用',
        'description' => '妥善保存這些備用碼，如果你的兩步驟驗證裝置遺失了可以用這些備用碼來恢復你的帳號。',
        'alert' => '這些代碼不會再次顯示。',
        'doneButton' => '完成',
    ],
];
